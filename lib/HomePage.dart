...
import 'package:cvdonna/Education.dart';
import 'package:cvdonna/Certificate.dart';
import 'package:cvdonna/Skills.dart';
import 'package:cvdonna/main.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        const CircleAvatar(
          ...
          radius: 95,
          backgroundImage: AssetImage('assets/images/donna.jpg'),
              ...
              const Text(
                ...
                style: TextStyle(
                  fontSize: 20,
                          ...
                          const Text(
                'email: donnaesculturadeguzman@gmail.com',
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
